        ...
        if($SQL_Query= mysqli_query($DB_Student, $SQL_Student)){
            if(mysqli_num_rows($SQL_Query)>0){
                while ($row = mysqli_fetch_array($SQL_Query)) {
                    ...
                    $id=$row['StudentID'];
                    echo "<td><a href='P5Q3edit-student.php?EditID=".$row['StudentID']."'>Edit</a> | <a href='P5Q3delete-student.php?DeleteID=".$row['StudentID']."'>Delete</a></td></tr>";
                    $count++;
                }
                echo "<tr><td colspan='5'>$count record(s) returned.\t[\t<a href='P5Q3insert-student.php'>Insert Student</a>\t]</td></tr>";
                echo "</table>";
            }
            else{
                echo "Not Records";
